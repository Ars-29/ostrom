...
const ImageCompressor = require('./compress-images.js');
const VideoCompressor = require('./compress-videos.js');
const TextureAtlasGenerator = require('./generate-texture-atlases.js');
